	  ...
	  <div class="row vertical-offset-100">
        ...
        <div class="panel-heading">
            <div class="row-fluid people-row">
                <img src="~assets/img/LOGO-01.png" class="img-responsive" alt="Console Admin" style="text-align: center; margin-left: 10px;"/>
            </div>
        </div>
...
<script>
  export default {
    ...
    mounted: function () {
      this.$refs.videoRef.src = '~assets/video/VORTEX.mp4'
